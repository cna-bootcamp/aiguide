...
- 프롬프팅:    
  ```
  [요청사항]
  - '{고객유형}' 10명을 관찰한 결과를 개별적으로 작성해 주세요.
  - 고객경험 단계: 인지 -> 탐색 및 평가 -> 가입 -> 이용 -> 관리 -> 최적화 -> 해지 -> 재가입 고려
  - 프로필에 연령대를 포함  
  [예시]
  - reference/sample_관찰결과 레포트.pdf  
  [결과형식]
  - 마크다운 표
  [결과파일]
  define/관찰결과.md
...
- 프롬프트팅  
  ```
  [요청사항]
  - '{고객유형}' 10명의 체험일지를 작성해 주세요.
  - 고객경험 단계: {고객경험 단계}
  [예시]
  - reference/sample_체험결과 레포트.pdf  
  [결과형식]
  - 마크다운 표
  [결과파일]
  define/체험결과.md
...
- 프롬프팅:  
  ...
  [예시]
  - reference/sample_고객경험인터뷰 결과지.pdf
  [결과형식]
  아티팩트
  [결과파일]
  define/고객경험인터뷰결과.md
...
- 프롬프팅   
  ...
  - define/문제가설.md
  [예시]
  - reference/sample_문제검증인터뷰 결과.pdf
  [결과형식]
  - 아티팩트  
  [결과파일]
  define/문제검증인터뷰결과.md
...
- 프롬프팅  
  ...
  [예시]
  - reference/sample_문제검증인터뷰 결과취합.pdf
  [결과형식]
  - 마크다운 표
  [결과파일]
...
- 프롬프팅
  ...
  - think/문제해결방향성.md
  - think/핵심솔루션.md
  - reference/Lean Canvas 작성 가이드.txt
  [결과형식]
  문단형식 
  [결과파일]
  think/비즈니스모델.md
